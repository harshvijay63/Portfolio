  ...
  return (
    <div className="home__data">
        ...
        <svg
         ...
         <h3 className="home__subtitle">Frontend Developer,Programmer,Coder </h3>
         <p className="home__description">
         I'm  Developer based in India, and I'm very passionate and dedicated to my work.
         </p>
